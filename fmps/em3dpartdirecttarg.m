...
mex_id_ = 'em3dpartdirecttarg(i dcomplex[x], i int[x], i double[], i int[x], i dcomplex[], i int[x], i dcomplex[], i int[x], io dcomplex[], i int[x], io dcomplex[], i int[x], i double[], i int[x], io dcomplex[], i int[x], io dcomplex[])';
[evec, hvec, evectarg, hvectarg] = fmps(mex_id_, zk, nsource, source, ifcjvec, cjvec, ifcmvec, cmvec, ifevec, evec, ifhvec, hvec, ntarget, target, ifevectarg, evectarg, ifhvectarg, hvectarg, 1, 1, 1, 1, 1, 1, 1, 1, 1);
