function [ra,rb]=rcoefs_die_arb21(nterms,omega,r,eps1,cmu1,eps2,cmu2)
%RCOEFS_DIE_ARB21 Construct reflection coefficients for a dielectric sphere.
%
%  [ra,rb]=rcoefs_die_arb21(nterms,omega,r,eps1,cmu1,eps2,eps2);
%
