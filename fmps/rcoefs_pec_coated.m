function [ra,rb,ta,tb]=rcoefs_pec_coated(nterms,omega,r1,r2,eps2,cmu2,eps3,cmu3)
...
%  for an arbitrary coated PEC sphere.
%
%  Incoming wave
%
%  Input parameters:
...
[ra21,rb21] = rcoefs_pec(nterms,omega,r1,eps2,cmu2);
