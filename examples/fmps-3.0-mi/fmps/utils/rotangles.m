function [sphere_rot]=rotangles(itype,sphere_rot)
%ROTANGLES Construct Euler rotation angles standard orientation types.
% 
%  [sphere_rot]=rotangles(itype,nspheres);
%
%  Input parameters:
% 
%    itype - rotation type
