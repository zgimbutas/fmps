...
title('absorption cross sections (SI)')
grid on

figure(5);
x = 11:120;
plot( gold_jc(x,2), real(qsca_total(x)) )
title('scattering cross sections (SI)')
grid on
...
title('Re electric polarization vector (SI)')
grid on

figure(12);
x = 11:120;
plot( gold_jc(x,2), imag(pdipole(1,x)))
title('Im electric polarization vector (SI)')
grid on
