...
%   mfie_w32 for Windows, 32 bit
%   mfie_w32_omp for Windows on multicore 32 bit machine with OpenMP
%   mfie_w64 for Windows, 64 bit
%   mfie_w64_omp for Windows on multicore 64 bit machine with OpenMP
%   mfie_lnx64 for Linux, 64 bit
%   mfie_lnx64_omp for Linux, 64 bit with OpenMP
%
%
...
%%%system(['./mfie_lnx64 ' config]);
%%%system(['./mfie_lnx64_omp ' config]);
