function [ra,rb]=rcoefs_pec(nterms,omega,r,eps1,cmu1)
%RCOEFS_PEC Construct reflection coefficients for a PEC sphere.
%
%  [ra,rb]=rcoefs_pec(nterms,omega,r,eps1,cmu1);
%
%  Construct reflection coefficients for a PEC sphere.
%  Incoming wave
%
%  Input parameters:
%
