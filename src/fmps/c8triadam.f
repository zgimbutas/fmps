...
c
c
        subroutine c8triaadam(ier,vert1,vert2,vert3,fun,nm,
...
c        subroutine c8triaadam (see above), and of the vector f in (1) 
c        above
...
c
        ...
        maxdepth=200
c
c        allocate memory for the subroutine c8trianrem
c
        istack=1
        lstack=1207
c
...
c       . . . integrate
c
        call c8trianrem(ier,w(istack),vert1,vert2,vert3,fun,nm,
...
c
c
        subroutine c8trianrem(ier,stack,z1,z2,z3,fun,nm,
...
c
        ...
        info(2)=0
c
cccc        call prinf('in c8trianrem, nm=*',nm,1)
c
...
c
 1000   continue
c
        call c8triainm1(m,z1,z2,z3,fun,
...
c
c
        call c8triainm1(m,zout(1,1,1),zout(1,2,1),zout(1,3,1),fun,
     1      p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,value1,w,ww,nm,vals2,numnodes)
        numfunev=numfunev+numnodes
c
        call c8triainm1(m,zout(1,1,2),zout(1,2,2),zout(1,3,2),fun,
     1      p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,value2,w,ww,nm,vals2,numnodes)
        numfunev=numfunev+numnodes
c
        call c8triainm1(m,zout(1,1,3),zout(1,2,3),zout(1,3,3),fun,
     1      p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,value3,w,ww,nm,vals2,numnodes)
        numfunev=numfunev+numnodes
c
        call c8triainm1(m,zout(1,1,4),zout(1,2,4),zout(1,3,4),fun,
...
c
        if( iffar .eq. 1 ) then
c
c       ... target is in the far field, good enough
c
c        call c8triainm1(m,stack(1,1,j),stack(1,2,j),stack(1,3,j),fun,
c     1      p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,vals(1,j),
...
c
c
        subroutine c8triainm1(n,vert1,vert2,vert3,fun,
...
c
        call c8triainm0(numnodes,w(irnodes),w(iweights),fun,
...
c
c
        subroutine c8triainm0(numnodes,rnodes,weights,fun,
